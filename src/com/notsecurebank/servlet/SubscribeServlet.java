...
public class SubscribeServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            messageSubscribe = "Thank you for subscribing to NotSecureBank. Please <a href='locations.jsp'>search</a> for the Branch Office closest to you and ask them for an account. Please <a href='login.jsp'>sign in</a> to use our advanced banking features.";
